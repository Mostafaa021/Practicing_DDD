...
namespace DddInPractice.UI
{
    public class SnackMachineViewModel : ViewModel
    {
        ...
        public SnackMachineViewModel(SnackMachine snackMachine)
        {
            ...
            InsertTenCentCommand = new Command(() => InsertMoney(Money.TenCents));
            InsertQuarterCommand = new Command(() => InsertMoney(Money.QuarterCents));
            InsertDollarCommand = new Command(() => InsertMoney(Money.OneDollar));
            InsertFiveDollarCommand = new Command(() => InsertMoney(Money.FiveDollars));
            InsertTwentyDollarCommand = new Command(() => InsertMoney(Money.TwentyDollars));
        ...
        {
            _snackMachine.BuySnack(1); // Assuming position 1 for simplicity
